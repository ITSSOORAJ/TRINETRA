...
def train():
    ...
    def train_model():
        ...
        def run_bim():
            ...
            progress_callback.switch_to_training_mode()  # Switch to training progress

        bim_thread = threading.Thread(target=run_bim)
        bim_thread.start()
        bim_thread.join()  # Wait for bim.main() to finish before training starts
